...
//import { medicalStyles as styles } from "@styles/medical";
import { medicalStyles as styles } from "../../styles/medical";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Need Medical Help</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <Pressable style={styles.callButton}>
        ...
        <Text style={styles.callText}>Call Medical Help Now</Text>
      </Pressable>
    </SafeAreaView>
  );
}
