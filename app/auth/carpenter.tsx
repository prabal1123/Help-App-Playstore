...
import { carpenterStyles as styles } from "@/styles/carpenter";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Need Carpenter</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <Pressable style={styles.callButton}>
        ...
        <Text style={styles.callText}>Call Carpenter Now</Text>
      </Pressable>
    </SafeAreaView>
  );
}
