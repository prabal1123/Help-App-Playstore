...
// import { electricianStyles } from "@/styles/electrician";
import { electricianStyles as styles } from "@/styles/electrician";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Need Electrician</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <Pressable style={styles.callButton}>
        ...
        <Text style={styles.callText}>Call Electrician Now</Text>
      </Pressable>
    </SafeAreaView>
  );
}
